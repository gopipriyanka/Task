        ...
        <tbody>
                    {users && users.map((item) => (
                        <tr key={item.symbol} style={{ border: '1px solid black' }}>
                            <td style={{ fontWeight: 'bolder', position: 'relative' }} className='item1'>
                            ...
                            <td style={{ color: 'green' }} className='item3'>
                            ...
                            <td className='item4'>{item.open}</td>
                            <td className='item5'>{item.pctChange}</td>
                            <td className='item6'>
